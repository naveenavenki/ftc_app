...
public class MecanumTeleOp implements BoKTeleop{
    ...
    private double gamePad1LeftStickX = 0;
    ...
    private double FRMotor = 0;
    private double FLMotor = 0;
    private double BRMotor = 0;
    private double BLMotor = 0;
    ...
    public void runSoftware(LinearOpMode opMode, BoKHardwareBot robot) {
        while (opMode.opModeIsActive()) {
            ...
            if ((Math.abs(gamePad1LeftStickY) > GAME_STICK_DEAD_ZONE) &&
                    (Math.abs(gamePad1LeftStickY) < -GAME_STICK_DEAD_ZONE)||(Math.abs(gamePad1LeftStickX) > GAME_STICK_DEAD_ZONE) &&
                    (Math.abs(gamePad1LeftStickX) < -GAME_STICK_DEAD_ZONE) ){
                FRMotor = gamePad1LeftStickY - gamePad1LeftStickX;
                FLMotor = -gamePad1LeftStickY - gamePad1LeftStickX;
                BRMotor = -gamePad1LeftStickY - gamePad1LeftStickX;
                BLMotor = gamePad1LeftStickY - gamePad1LeftStickX;
            ...
            if ((gamePad1RightStickX > GAME_STICK_DEAD_ZONE) &&
                ...
                FRMotor = -gamePad1RightStickX;
                FLMotor = -gamePad1RightStickX;
                BRMotor = gamePad1RightStickX;
                BLMotor = gamePad1RightStickX;
